...
public class ParametroProdutoEsteiraControllerTest {
    ...
    public void whenPostNewParametroPrudutoEsteira_thenReturnCreatedWithNewObject() {
        ...
        ParametroProdutoEsteiraPostDto toSave = new ParametroProdutoEsteiraPostDto(
                33,
                3,
                "S",
                "S",
        ...
        HttpEntity<ParametroProdutoEsteiraPostDto> request =
                new HttpEntity<ParametroProdutoEsteiraPostDto>(toSave);
